...
public class PayOSPaymentStrategy implements PaymentStrategy {
    ...
    public PaymentResult createPayment(OrderInternalResponse order) {
        ...
        CreatePaymentLinkRequest paymentData = CreatePaymentLinkRequest.builder()
                ...
                .returnUrl(frontendDomain + "/" + Objects.requireNonNullElse(order.getLocale(), "vi") + "/user/events/" + order.getEventId() + "/payment/result?status=success")
                .cancelUrl(frontendDomain + "/" + Objects.requireNonNullElse(order.getLocale(), "vi") + "/user/events/" + order.getEventId() + "/payment/result?status=cancelled")
                .build();
