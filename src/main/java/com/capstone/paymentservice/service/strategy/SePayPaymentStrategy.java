...
public class SePayPaymentStrategy implements PaymentStrategy {
    ...
    public PaymentResult createPayment(OrderInternalResponse order) {
        ...
        fields.put("error_url", backendDomain + "/order-service/api/v1/orders/cancel-callback?orderCode=" + order.getOrderCode() + "&eventId=" + order.getEventId() + "&locale=" + locale);
        fields.put("cancel_url", backendDomain + "/order-service/api/v1/orders/cancel-callback?orderCode=" + order.getOrderCode() + "&eventId=" + order.getEventId() + "&locale=" + locale);
